...
def seed_farms():
    farm1 = [
        ...
        Farm(
            ...
            address="5102 NY-89, Romulus, NY 14541", state="New York", latitude=42.781632803263356, longitude=-76.7689058389861),
        Farm(
            ...
            address="815 Taber St, Ithaca, NY 14850", state="New York", latitude=42.439552296532526, longitude=-76.51518338835389),
        Farm(
            ...
            address="Twin Grove Rd, Monroe, WI 53566", state="Wisconsin", latitude=42.50791679838536, longitude=-89.54009110377567),
        Farm(
            ...
            address="1734 Wayside Rd, Greenleaf, WI 54126", state="Wisconsin", latitude=44.25391809366659, longitude=-88.08827045954783),
        Farm(
            ...
            address="N4893 County C, Kewaunee, WI 54216", state="Wisconsin", latitude=44.502687011036365, longitude=-87.60007563070505),
        Farm(
            ...
            address="2-454 State Route 15, Bryan, OH 43506", state="Ohio", latitude=41.448531057300734, longitude=-84.5501422191473),
        Farm(
            ...
            address="7506 Cole Rd, Crestline, OH 44827", state="Ohio", latitude=40.871375012227496, longitude=-82.75708054430339),
        Farm(
            ...
            address="867 W Town St, Columbus, OH 43222", state="Ohio", latitude=39.95594434991887, longitude=-83.02311907501166),
        Farm(
            ...
            address="Jamul, CA 91935", state="California", latitude=32.717107101363396, longitude=-116.87618834635825),
        Farm(
        ...
        Farm(
            ...
            address="5601 Casitas Pass Rd, Carpinteria, CA 93013", state="California", latitude=34.40485257652301, longitude=-119.5029628156356),
    ]
